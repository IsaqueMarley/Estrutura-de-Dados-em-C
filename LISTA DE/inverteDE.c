...
void inverter(LISTA *l)
{
  ...
  itemAtual->prox = NULL;
  itemAtual->ant = itemProx;

  while (itemProx) // se proximo eh item !=  NULL 
  {
	itemProx->ant = itemProx->prox;
	itemProx->prox = itemAtual;
	itemAtual = itemProx;
	itemProx = itemProx->ant;
  }

  aux = l->cabeca; // guardando a cabeca

  l->cabeca = l->cauda; // o item da cauda agr eh da cabeca

  l->cauda = aux;  // a cauda rebece o item da cabeca
